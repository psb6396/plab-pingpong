...
import { createGame, getCreatedGames, deleteGame, getGameById, updateGame } from '../api/gameApi'
...
//게임 수정 Thunk
export const updateGameThunk = createAsyncThunk('games/updateGame', async (data, { rejectWithValue }) => {
   try {
